...
- Do NOT include <script> tags Ã¢â‚¬â€ scripts are added at assembly time.
...
- Never use emojis Ã¢â‚¬â€ use inline SVG icons styled to match the selected typography (stroke weight, fill vs outline, rounded vs sharp).
- Always implement mobile navigation with CSS transitions on max-height and opacity Ã¢â‚¬â€ never toggle display:none or the hidden class.
