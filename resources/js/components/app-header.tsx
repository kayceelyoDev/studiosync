    ...
    return (
        <>
                                ...
                                {mainNavItems.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        {isCurrentUrl(item.href) && (
                                            <div className="absolute bottom-0 left-0 h-0.5 w-full translate-y-px bg-green-600"></div>
                                        )}
                                    </NavigationMenuItem>
                                ))}
                            </NavigationMenuList>
            ...
            {breadcrumbs.length > 1 && (
                <div className="flex w-full bg-background border-b border-border">
